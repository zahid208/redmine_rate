class RateCachesController < ApplicationController
  ...
  def index
    @last_caching_run = if Setting.plugin_redmine_rate['last_caching_run'].present? &&
    ...
    @last_cache_clearing_run = if Setting.plugin_redmine_rate['last_cache_clearing_run'].present? &&
