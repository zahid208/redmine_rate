...
<img src="https://pm.alphanodes.com/jenkins/buildStatus/icon?job=Devel-build-redmine-rate" alt="Jenkins Build Status" />
...
To install the redmine_rate, execute the following commands from the root of your redmine directory, assuming that your RAILS_ENV environment variable is set to "production":
 ...
 bundle install
 bundle rake redmine:plugins:migrate NAME=redmine_rate
